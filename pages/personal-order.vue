          ...
          <div class="chat-card__content">
            ...
            <div class="chats">
                <div class="chat-aside" v-if="navIsShown">
                  <ChatPersonalOrderMsg />
                </div>
              <div class="websoket-chat">
                <div class="websoket-chat__content">
                  <div class="header-title">
                    <h4 class="chat-aside__title h1">Заказы</h4>
                  </div>
                  <div class="chat-wrap">
                    <div class="chat-child-flex">
                      <div class="chat-wrap-product" v-for="item in products">
                        ...
                        <div class="chat-wrap-product-text">
                          <div class="chat-wrap-product-text-flex">
                            <div class="boxs">
                              <div class="wrap-background" :class="item.class"></div>
                              <h4>{{ item.title }}</h4>
                            </div>
                          ...
                          <h4>01.22.23 · 18:00 - 22:00</h4>
                          <h4>Сауна Дионис-СПА</h4>
                          <span>Горячий сруб</span>
                          <h2>22 300 ₽ </h2>
                          <span>ул. Тимирязьева, м. Могилевская</span>
                        </div>
                      </div>
                    </div>
                    <div class="chat-child-flex mll">
