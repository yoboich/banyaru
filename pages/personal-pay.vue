          ...
          <div class="chat-card__content">
            <div class="chat-header">
              ...
              <div class="chat-header__item">
                <h4 class="chat-aside__title h1">Пока в корзине ничего нет</h4>
              </div>
            </div>
            <div class="chats">
                ...
                <div class="websoket-chat__content">
                  ...
                  <div class="chat-wrap">
                    <div class="chat-child-flex">
                      <div class="chat-wrap-product" v-for="item in products">
                        <div class="products-images">
                          <img :src="'/_nuxt/assets/img/chat/' + item.image" alt="girl-sauna" class="like-image">
                          <div class="chat-wrap-product-text">
                            <img src="../assets/img/chat/likes-image.png" alt="like">
                            <h4>Сауна Дионис-СПА</h4>
                            <div class="middle-box">
                              <div class="circle-box"></div>
                              <h4>Павелецкая</h4>
