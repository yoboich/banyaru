...
onMounted(() => {
  ...
  let product1 = document.querySelector('.hover11')
  let product2 = document.querySelector('.hover12')
  let product3 = document.querySelector('.hover13')
  let product4 = document.querySelector('.hover14')
...
<template>
  ...
  <nuxt-link to="/order">
    <div class="map-btns1">
      <button class="btn11">500 ₽</button>
      <button class="btn12">1000 ₽</button>
      <button class="btn13">700 ₽</button>
      <button class="btn14">800 ₽</button>
    </div>
  </nuxt-link>
...
.map-btns1 {
  ...
  @media(max-width: 1500px) {
    transform: translateX(761px) translateY(-660px) !important;
  }
  & button {
    background: #ffff;
    box-shadow: 0px 4px 21px rgba(143, 153, 186, 0.7);
