...
onMounted(() => {
  ...
  let product1 = document.querySelector('.hover1')
  let product2 = document.querySelector('.hover2')
  let product3 = document.querySelector('.hover3')
  let product4 = document.querySelector('.hover4')

  product1.addEventListener('mouseover', () => {
    btn1.classList.toggle('hover-active')
    btn2.classList.remove('hover-active')
    btn3.classList.remove('hover-active')
  })
  product2.addEventListener('mouseover', () => {
    btn2.classList.toggle('hover-active')
    btn1.classList.remove('hover-active')
    btn3.classList.remove('hover-active')
  })
  product3.addEventListener('mouseover', () => {
    btn3.classList.toggle('hover-active')
    btn1.classList.remove('hover-active')
    btn2.classList.remove('hover-active')
  })
  product4.addEventListener('mouseover', () => {
    btn4.classList.add('hover-active')
    btn1.classList.remove('hover-active')
    btn2.classList.remove('hover-active')
    btn3.classList.remove('hover-active')
  })
  ...
  product4.addEventListener('mouseout', () => {
    btn4.classList.remove('hover-active')
    btn1.classList.remove('hover-active')
    btn2.classList.remove('hover-active')
    btn3.classList.remove('hover-active')
  })
...
<template>
  <swiper :navigation="true" :modules="modules" class="mySwiper">
    <swiper-slide>
      <nuxt-link to="/modal">
        <div class="swiper-image backgrounds hover1">
    ...
    <swiper-slide>
      <nuxt-link to="/modal">
        <div class="swiper-image backgrounds hover3">
          <img src="../../assets/img/order/background.png" alt="room">
        </div>
      </nuxt-link>
    </swiper-slide>
  ...
  <div class="swiper-footer">
    ...
    <div class="swiper-footer-box">
      <img src="../../assets/img/order/product-images.png" alt="product-images">
  ...
  <nuxt-link to="/order">
    <div class="map-btns">
      <button class="btn1">200 ₽</button>
      <button class="btn2">1200 ₽</button>
      <button class="btn3">2000 ₽</button>
      <button class="btn4">1400 ₽</button>
    </div>
  </nuxt-link>
</template>
...
.map-btns {
  transform: translateX(1200px) translateY(-500px) !important;
  position: absolute;
  display: grid;
  grid-template-columns: 1fr 1fr 1fr 1fr;
  @media(max-width: 1500px) {
    transform: translateX(761px) translateY(-494px) !important;
  }
  & button {
    background: #ffff;
    box-shadow: 0px 4px 21px rgba(143, 153, 186, 0.7);
